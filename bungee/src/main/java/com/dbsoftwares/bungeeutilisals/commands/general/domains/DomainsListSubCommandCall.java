...
import com.dbsoftwares.bungeeutilisalsx.common.utils.UserUtils;
...
public class DomainsListSubCommandCall implements CommandCall
{
    ...
    {
        final Map<String, Integer> domains = BUCore.getApi().getStorageManager().getDao().getUserDao().getJoinedHostList();
