...
public class FriendDenySubCommand extends SubCommand {

    public FriendDenySubCommand() {
        super(
                "deny", 1, 1,
                Arrays.asList(FileLocation.FRIENDS_CONFIG.getConfiguration().getString("subcommands.deny.aliases").split(", "))
        );
    }
