...
package com.dbsoftwares.bungeeutilisals.packet.event;
...
public class PacketUpdateEvent extends AbstractEvent implements Cancellable {
    ...
    public PacketUpdateEvent(DefinedPacket packet, ProxiedPlayer p, Connection sender, Connection receiver) {
