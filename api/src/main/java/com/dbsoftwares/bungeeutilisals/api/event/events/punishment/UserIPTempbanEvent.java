...
/**
 * This event will be executed upon User IP Tempban.
 */
public class UserIPTempbanEvent extends AbstractEvent {

    @Getter @Setter String userName;
    @Getter @Setter String bannerName;
    @Getter @Setter PunishmentInfo info;

    public UserIPTempbanEvent(String user, String banner, PunishmentInfo info) {
        this.userName = user;
