package com.dbsoftwares.bungeeutilisals.api.utils.unicode;

import java.io.IOException;
import java.io.StringWriter;
import java.io.Writer;

// UnicodeTranslator from Apache text commons. Copied because this API is not present in Bungeecord.
