...
/**
 * This event will be executed upon User IP Mute.
 */
public class UserIPMuteEvent extends AbstractEvent {

    @Getter @Setter String userName;
    @Getter @Setter String bannerName;
    @Getter @Setter PunishmentInfo info;

    public UserIPMuteEvent(String user, String banner, PunishmentInfo info) {
        this.userName = user;
