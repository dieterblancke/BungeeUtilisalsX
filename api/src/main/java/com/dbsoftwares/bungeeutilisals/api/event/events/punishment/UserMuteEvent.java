...
/**
 * This event will be executed upon User Mute.
 */
public class UserMuteEvent extends AbstractEvent {

    @Getter @Setter String userName;
    @Getter @Setter String bannerName;
    @Getter @Setter PunishmentInfo info;

    public UserMuteEvent(String user, String banner, PunishmentInfo info) {
        this.userName = user;
