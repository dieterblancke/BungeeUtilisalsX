...
/**
 * This event will be executed upon User IP Tempmute.
 */
public class UserIPTempmuteEvent extends AbstractEvent {

    @Getter @Setter String userName;
    @Getter @Setter String bannerName;
    @Getter @Setter PunishmentInfo info;

    public UserIPTempmuteEvent(String user, String banner, PunishmentInfo info) {
        this.userName = user;
