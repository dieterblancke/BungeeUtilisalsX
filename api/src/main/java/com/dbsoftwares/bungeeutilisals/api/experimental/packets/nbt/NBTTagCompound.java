...
public class NBTTagCompound extends NBTBase {
    ...
    public byte b(String paramString) {
        NBTBase localNBTBase = this.map.get(paramString);
    ...
    public boolean hasKeyOfType(String paramString, int paramInt) {
        int i = b(paramString);
        return i == paramInt || paramInt == 99 && ((i == 1) || (i == 2) || (i == 3) || (i == 4) || (i == 5) || (i == 6));
    }
    ...
    public String getString(String paramString) {
        try {
            ...
            return this.map.get(paramString).a_();
        } catch (ClassCastException ignored) { }
        return "";
    }
    ...
    public String toString() {
        ...
        for (String str : this.map.keySet()) {
            builder.append(str).append(':').append(this.map.get(str)).append(',');
        }
        builder.append("}");
    ...
    public NBTBase clone() {
        ...
        for (String str : this.map.keySet()) {
            localNBTTagCompound.set(str, this.map.get(str).clone());
        }
    ...
    public void a(NBTTagCompound paramNBTTagCompound) {
        for (String str : paramNBTTagCompound.map.keySet()) {
            NBTBase localNBTBase = paramNBTTagCompound.map.get(str);
