...
package com.dbsoftwares.bungeeutilisalsx.common.converter.converters;
...
public class MongoToMongoConverter extends Converter
{
    ...
    {
        return ( (com.dbsoftwares.bungeeutilisalsx.common.storage.mongodb.MongoDBStorageManager) BuX.getInstance().getAbstractStorageManager() ).getDatabase();
    }
