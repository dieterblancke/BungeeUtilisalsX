...
public class UnmuteCommand extends Command {
    ...
    public UnmuteCommand() {
        super("unmute", Arrays.asList(BungeeUtilisals.getConfiguration(FileLocation.PUNISHMENTS_CONFIG)
                        .getString("commands.unmute.aliases").split(", ")),
                BungeeUtilisals.getConfiguration(FileLocation.PUNISHMENTS_CONFIG).getString("commands.unmute.permission"));
    }
    ...
    public void onExecute(User user, String[] args) {
        ...
        api.langBroadcast("punishments.unmute.broadcast",
                BungeeUtilisals.getConfiguration(FileLocation.PUNISHMENTS_CONFIG).getString("commands.unmute.broadcast"),
