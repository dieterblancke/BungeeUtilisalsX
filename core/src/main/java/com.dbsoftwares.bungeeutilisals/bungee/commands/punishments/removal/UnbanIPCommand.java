...
public class UnbanIPCommand extends Command {
    ...
    public UnbanIPCommand() {
        super("unbanip", Arrays.asList(BungeeUtilisals.getConfiguration(FileLocation.PUNISHMENTS_CONFIG)
                        .getString("commands.unbanip.aliases").split(", ")),
                BungeeUtilisals.getConfiguration(FileLocation.PUNISHMENTS_CONFIG).getString("commands.unbanip.permission"));
    }
    ...
    public void onExecute(User user, String[] args) {
        ...
        api.langBroadcast("punishments.unbanip.broadcast",
                BungeeUtilisals.getConfiguration(FileLocation.PUNISHMENTS_CONFIG).getString("commands.unbanip.broadcast"),
