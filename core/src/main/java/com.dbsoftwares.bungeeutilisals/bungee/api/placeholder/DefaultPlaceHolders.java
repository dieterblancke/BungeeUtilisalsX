    ...
    public void loadPack() {
        PlaceHolderAPI.addPlaceHolder("{users-table}", false, new PlaceHolderEventHandler() {
            ...
            public String getReplace(PlaceHolderEvent event) {
                return BungeeUtilisals.getConfigurations().get(FileLocations.MYSQL).getString("user-table");
            }
        });
        PlaceHolderAPI.addPlaceHolder("{friends-table}", false, new PlaceHolderEventHandler() {
            @Override
            public String getReplace(PlaceHolderEvent event) {
                return BungeeUtilisals.getConfigurations().get(FileLocations.FRIENDS_CONFIG).getString("tables.friends");
            }
        });
        PlaceHolderAPI.addPlaceHolder("{friendrequests-table}", false, new PlaceHolderEventHandler() {
            @Override
            public String getReplace(PlaceHolderEvent event) {
                return BungeeUtilisals.getConfigurations().get(FileLocations.FRIENDS_CONFIG).getString("tables.requests");
            }
        });
        PlaceHolderAPI.addPlaceHolder("{bans-table}", false, new PlaceHolderEventHandler() {
            @Override
            public String getReplace(PlaceHolderEvent event) {
                return BungeeUtilisals.getConfigurations().get(FileLocations.PUNISHMENTS_CONFIG).getString("tables.bans");
            }
        });
        PlaceHolderAPI.addPlaceHolder("{ipbans-table}", false, new PlaceHolderEventHandler() {
            @Override
            public String getReplace(PlaceHolderEvent event) {
                return BungeeUtilisals.getConfigurations().get(FileLocations.PUNISHMENTS_CONFIG).getString("tables.ipbans");
            }
        });
        PlaceHolderAPI.addPlaceHolder("{tempbans-table}", false, new PlaceHolderEventHandler() {
            @Override
            public String getReplace(PlaceHolderEvent event) {
                return BungeeUtilisals.getConfigurations().get(FileLocations.PUNISHMENTS_CONFIG).getString("tables.tempbans");
            }
        });
        PlaceHolderAPI.addPlaceHolder("{iptempbans-table}", false, new PlaceHolderEventHandler() {
            @Override
            public String getReplace(PlaceHolderEvent event) {
                return BungeeUtilisals.getConfigurations().get(FileLocations.PUNISHMENTS_CONFIG).getString("tables.iptempbans");
            }
        });
        PlaceHolderAPI.addPlaceHolder("{mutes-table}", false, new PlaceHolderEventHandler() {
            @Override
            public String getReplace(PlaceHolderEvent event) {
                return BungeeUtilisals.getConfigurations().get(FileLocations.PUNISHMENTS_CONFIG).getString("tables.mutes");
            }
        });
        PlaceHolderAPI.addPlaceHolder("{ipmutes-table}", false, new PlaceHolderEventHandler() {
            @Override
            public String getReplace(PlaceHolderEvent event) {
                return BungeeUtilisals.getConfigurations().get(FileLocations.PUNISHMENTS_CONFIG).getString("tables.ipmutes");
            }
        });
        PlaceHolderAPI.addPlaceHolder("{tempmutes-table}", false, new PlaceHolderEventHandler() {
            @Override
            public String getReplace(PlaceHolderEvent event) {
                return BungeeUtilisals.getConfigurations().get(FileLocations.PUNISHMENTS_CONFIG).getString("tables.tempmutes");
            }
        });
        PlaceHolderAPI.addPlaceHolder("{iptempmutes-table}", false, new PlaceHolderEventHandler() {
            @Override
            public String getReplace(PlaceHolderEvent event) {
                return BungeeUtilisals.getConfigurations().get(FileLocations.PUNISHMENTS_CONFIG).getString("tables.iptempmutes");
            }
        });
        PlaceHolderAPI.addPlaceHolder("{kicks-table}", false, new PlaceHolderEventHandler() {
            @Override
            public String getReplace(PlaceHolderEvent event) {
                return BungeeUtilisals.getConfigurations().get(FileLocations.PUNISHMENTS_CONFIG).getString("tables.kicks");
            }
        });
        PlaceHolderAPI.addPlaceHolder("{warns-table}", false, new PlaceHolderEventHandler() {
            @Override
            public String getReplace(PlaceHolderEvent event) {
                return BungeeUtilisals.getConfigurations().get(FileLocations.PUNISHMENTS_CONFIG).getString("tables.warns");
            }
        });
    }
}