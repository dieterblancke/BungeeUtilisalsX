...
@NoArgsConstructor
@AllArgsConstructor
@StorageTable(name = "{mutes-table}", indexes = {"uuid", "user", "active", "ip"}, foreign = {"uuid => {users-table}(uuid)"})
public class MutesTable implements PunishmentTable {
    ...
    public static MutesTable fromInfo(PunishmentInfo info) {
        MutesTable table = new MutesTable();
