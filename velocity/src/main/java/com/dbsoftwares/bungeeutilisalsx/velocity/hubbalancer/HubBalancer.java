package com.dbsoftwares.bungeeutilisalsx.velocity.hubbalancer;
...
import com.dbsoftwares.bungeeutilisalsx.velocity.hubbalancer.listeners.JoinListener;
import com.dbsoftwares.bungeeutilisalsx.velocity.hubbalancer.listeners.KickListener;
import com.dbsoftwares.bungeeutilisalsx.velocity.hubbalancer.tasks.ServerPingTask;
...
public class HubBalancer implements IHubBalancer
{
    ...
    public HubBalancer()
    {
        ...
        Bootstrap.getInstance().getProxyServer().getEventManager().register( Bootstrap.getInstance(), new JoinListener() );
        Bootstrap.getInstance().getProxyServer().getEventManager().register( Bootstrap.getInstance(), new KickListener() );
    }
